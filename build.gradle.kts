...
repositories {
    ...
    ivy("https://github.com/Gooey-Goo/BTANoNameDyes") {
        patternLayout { artifact("releases/download/v[revision]/[module]-[revision].jar") }
        metadataSources { artifact() }
    }
...
dependencies {
    ...
    compileOnly(libs.nonamedyes)
    implementation(libs.betterWithAether)
...
tasks {
    ...
    processResources {
        val resourceMap = mapOf(
            ...
            "aether" to libs.versions.betterWithAether.get(),
            "nonamedyes" to libs.versions.nonamedyes.get()
        )
