...
public class EntityPoisonFX extends net.minecraft.client.render.particle.ParticleFlame {
	public EntityPoisonFX(World world, double d, double d1, double d2, double d3, double d4, double d5, Type type) {
		...
		this.tex = TextureRegistry.getTexture("shieldmod:particle/purple_fire");
	}
